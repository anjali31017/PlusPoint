...
//     container.empty();
//     container.append('<h2 class="text-xl font-bold mb-4">Articles</h2>');
...
//         // Filter published articles and take top 5 by likes
...
//             type: 'bar',
//             data: {
//                 labels: topArticles.map(a => a.title), // titles for labels
//                 datasets: [{
//                     label: 'Likes',
...
//                     },
//                     y: {
//                         title: { display: true, text: 'Top 5 Articles' },
//                         ticks: {
//                             callback: function(value, index) {
//                                 return ''; // We'll show titles in the legend below instead
//                             }
//                         },
//                         grid: { display: false }
//                     }
